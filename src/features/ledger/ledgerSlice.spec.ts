...
describe('ledger reducer', () => {
  ...
  it('should handle incrementByAmount', () => {
    const actual = ledgerReducer(initialState, incrementByAmount({value: 4, date: "112233"}));
    expect(actual.startingBalance).toEqual(7);
  });

  it('should handle decrementByAmount', () => {
    const actual = ledgerReducer(initialState, decrementByAmount({value: 2, date: "112233"}));
